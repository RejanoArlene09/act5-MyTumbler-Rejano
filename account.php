...
.cover {
    background-image: url('image/arlene.png');
        ...
        <div class="bg-white shadow rounded overflow-hidden">
            <div class="px-4 pt-0 pb-4 cover">
                <div class="media align-items-end profile-head">
                    <div class="profile mr-3"><img src="images/ynx.jpg" alt="..." width="150" class="rounded mb-2 img-thumbnail">
            ...
            <div class="py-4 px-4">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-2 pr-lg-1"><img src="images/kyle.jpg" alt="" class="img-fluid rounded shadow-sm"></div>              
                    <div class="col-lg-6 mb-2 pl-lg-1"><img src="images/y.jpg" alt="" class="img-fluid rounded shadow-sm"></div>                
                    <div class="col-lg-6 pr-lg-1 mb-2"><img src="images/u.jpg" alt="" class="img-fluid rounded shadow-sm"></div>
                    <div class="col-lg-6 pl-lg-1"><img src="images/x.jpg" alt="" class="img-fluid rounded shadow-sm"></div>
                </div> 
            </div>
