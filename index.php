...
//CREATE A PRE DEFINED USERNAME AND  without data base
$acc_username = "ArleneRejano";
$acc_password = "rejanoLove09";
$acc_fullname = "Rejano Arlene";
$acc_adresss = "Mogpog Marinduque";

//check the current url for the redirections later
$url_add = "http://".$_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF'];

//condition to know the button is cicked
if (isset($_REQUEST['login_button']) === true){
	// get the username and password from the form and compare to the predefined username and password
     if($_REQUEST['form_username'] != $acc_username){
     	...
     	$_SESSION['ses_address'] = $acc_adresss;
